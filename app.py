import os, time, random, smtplib, json, mimetypes, ssl # AGREGADO: ssl para la conexión segura
...
# AGREGADO: Soporte para textos muy largos en formularios (evita que se corte)
...
def enviar_codigo(correo_destino, codigo):
    ...
    try:
        # AGREGADO: Forzar conexión ignorando bloqueos de certificados locales o antivirus
        contexto = ssl.create_default_context()
        contexto.check_hostname = False
        contexto.verify_mode = ssl.CERT_NONE
        
        # AGREGADO: Usamos SMTP_SSL en puerto 465 (el más estable)
        ...
        # AGREGADO: Impresión gigante del error para saber exactamente qué falla
        print(f"\n=========================================")
        print(f"❌ ERROR EXACTO DE GMAIL: {e}")
        print(f"=========================================\n")
        return False
...
if __name__ == '__main__':
    # AGREGADO: Ajuste para que reconozca puertos externos de Render, Railway, etc.
